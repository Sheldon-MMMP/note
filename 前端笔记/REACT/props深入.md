...
### [](https://zh-hans.reactjs.org/docs/typechecking-with-proptypes.html#proptypes)PropTypes
...
### [](https://zh-hans.reactjs.org/docs/typechecking-with-proptypes.html#requiring-single-child)限制单个元素
...
### [](https://zh-hans.reactjs.org/docs/typechecking-with-proptypes.html#default-prop-values)默认 Prop 值
...
### [](https://zh-hans.reactjs.org/docs/typechecking-with-proptypes.html#function-components)函数组件
